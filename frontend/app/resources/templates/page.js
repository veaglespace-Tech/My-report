...
export default function TemplatesPage() {
  return (
    <div className="relative overflow-hidden">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-[-260px] -z-10 h-[560px] w-[560px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(79,209,197,0.28),transparent_65%)] blur-2xl"
      />
