...
export default function StoreGuidePage() {
  return (
    <div className="relative overflow-hidden">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-[-260px] -z-10 h-[560px] w-[560px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(124,140,255,0.26),transparent_65%)] blur-2xl"
      />
